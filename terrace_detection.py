...
def get_detections(image_path, output_path = None, detection_threshold: float = 0.5):
    ...
    text_labels = [["roof railings"]] # roof
...
if __name__ == "__main__":
    image_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Paintable_Area_Calculation\Images\OrgImages\Image_21.jpg"
    output_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Paintable_Area_Calculation\Images\Modify\Detected_Terrace_21.jpg"
    get_detections(image_path = image_path, output_path = output_path, detection_threshold = 0.4)