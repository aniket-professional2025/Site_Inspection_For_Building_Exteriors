...
def get_detections(image_path, output_path = None, detection_threshold: float = 0.5):
    ...
    text_labels = [["water body"]] # With threshold 
...
if __name__ == "__main__":
    image_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Paintable_Area_Calculation\Images\OrgImages\Stagnant_Water_3.jpg"
    output_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Paintable_Area_Calculation\Images\Modify\Detected_Water_3.jpg"
    get_detections(image_path = image_path, output_path = output_path, detection_threshold = 0.6)