...
def get_detections(image_path, output_path = None, detection_threshold: float = 0.5):
    ...
    text_labels = [["pipes"]] # With threshold 0.19
...
if __name__ == "__main__":
    ...
    output_path = r"C:\Users\Webbies\Jupyter_Notebooks\Berger_Building_Height_Width\Images\Modify\Detected_Pipe.jpg"
    get_detections(image_path = image_path, output_path = output_path, detection_threshold = 0.19)