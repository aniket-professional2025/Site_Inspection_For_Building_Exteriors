...
# import tempfile
# import os
# from main import calculate_paintable_area
...
#     else:
#         st.info("🔍 Running paintable area calculation... Please wait.")
...
#             try:
#                 # Only pass the first 4 images if 5 are uploaded, to keep your existing function signature
#                 args = dict(
...
#                 wc, dc, pc, total_building_area, total_wdp_area, paintable_area = calculate_paintable_area(**args)
...
#                 col1.metric("🪟 Window Count", int(wc))
#                 col2.metric("🚪 Door Count", int(dc))
#                 col3.metric("🧱 Pipe Count", int(pc))

#                 col4, col5, col6 = st.columns(3)
#                 col4.metric("🏢 Total Building Area", f"{total_building_area:.2f} sq.ft")
#                 col5.metric("🚪🪟 Total WDP Area", f"{total_wdp_area:.2f} sq.ft")
#                 col6.metric("🎨 Paintable Area", f"{paintable_area:.2f} sq.ft")
